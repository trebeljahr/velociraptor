...
export function SoundSettings({ callbacks: cb }: SoundSettingsProps) {
  ...
  return (
    <>
      <button className="menu-item" type="button" onClick={(e) => { stop(e); cb.onToggleSound(); }}>
        <span className="inner">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="-5 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <button className="menu-item" type="button" onClick={(e) => { stop(e); cb.onToggleMusic(); }}>
        <span className="inner">
      ...
      <button className="menu-item" type="button" onClick={(e) => { stop(e); cb.onToggleJumpSound(); }}>
        <span className="inner">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <button className="menu-item" type="button" onClick={(e) => { stop(e); cb.onToggleRainSound(); }}>
        <span className="inner">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <button className="menu-item" type="button" onClick={(e) => { stop(e); cb.onToggleThunder(); }}>
        <span className="inner">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <button className="menu-item" type="button" onClick={(e) => { stop(e); cb.onToggleFootsteps(); }}>
        <span className="inner">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <button className="menu-item" type="button" onClick={(e) => { stop(e); cb.onToggleCoinsSound(); }}>
        <span className="inner">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <button className="menu-item" type="button" onClick={(e) => { stop(e); cb.onToggleUiSound(); }}>
        <span className="inner">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <button className="menu-item" type="button" onClick={(e) => { stop(e); cb.onToggleEventsSound(); }}>
        <span className="inner">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
